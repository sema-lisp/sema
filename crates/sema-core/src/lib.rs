...
pub use async_signal::{
    ...
    notify_task_reaped, otel_ambient_is_empty, otel_captured_is_empty,
    promise_driven_quantum_active, set_blocking_sleep_callback, set_current_task_id,
...
pub use output_hook::{
    capturing_root_count, install_output_capture_sink, mark_root_capturing, set_current_root,
    set_stderr_hook, set_stdout_hook, unmark_root_capturing, write_stderr, write_stdout,
    CapturedOutput,
};
