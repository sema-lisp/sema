...
pub use vm::{
    ...
    is_debug_session_active, program_as_callable, snap_breakpoint_line, snapshot_escaping_closure,
    snapshot_native_escaping_args_for_current_vm, valid_breakpoint_lines,
