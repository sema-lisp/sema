...
eval_tests! {
    ...
    str_index_of_with_offset: r#"(string/index-of "abcabc" "bc" 2)"# => Value::int(4),
    str_index_of_offset_past_first_match: r#"(string/index-of "abcabc" "bc" 4)"# => Value::int(4),
    str_index_of_offset_not_found: r#"(string/index-of "abcabc" "bc" 5)"# => Value::nil(),
    str_index_of_offset_zero: r#"(string/index-of "abcabc" "bc" 0)"# => Value::int(1),
    str_index_of_offset_unicode: r#"(string/index-of "café café" "café" 1)"# => Value::int(5),
