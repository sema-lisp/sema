...
eval_tests! {
    ...
    text_excerpt_expanding_prefix: r#"(text/excerpt "İéz" "é" {:radius 0})"# => Value::string("...é..."),
    text_excerpt_shrinking_prefix: r#"(text/excerpt "Kéz" "é" {:radius 0})"# => Value::string("...é..."),
    text_excerpt_expanded_match: r#"(text/excerpt "aİz" "i̇" {:radius 0})"# => Value::string("...İ..."),
    text_excerpt_partial_expansion: r#"(text/excerpt "aİz" "i" {:radius 0})"# => Value::string("...İ..."),
    text_excerpt_contextual_lowercase: r#"(text/excerpt "ΟΣ éz" "ος" {:radius 0})"# => Value::string("ΟΣ..."),
    text_excerpt_empty_query: r#"(text/excerpt "hello" "" {:radius 0})"# => Value::string("..."),
    text_excerpt_unicode_radius: r#"(text/excerpt "aİézq" "é" {:radius 1})"# => Value::string("...İéz..."),
